...
public class WavFileReader implements AutoCloseable {
    ...
    public static WavFileReader openWavFile(InputStream in) throws IOException {
        WavFileReader wavFile = new WavFileReader();
        wavFile.iStream = in;
